...
$(function () {
    ...
    function setNameValidationMessage(nameId) {
    ...
    function setDateValidationMessage() {
    ...
    function setPhoneValidationMessage() {
        if (phoneValidation()) {
    ...
    function setPasswordValidationMessage() {
    ...
    function setConfirmPasswordValidationMessage() {
    ...
    function dateValidation(dateId) {
